odoo.define('pos_cardknox_integration.PaymentScreen', function(require) {
    ...
    const PosCardknoxPaymentScreen = PaymentScreen => class extends PaymentScreen {
        constructor() {
            super(...arguments);
            onMounted(() => {
                const pendingPaymentLine = this.currentOrder.paymentlines.find(
                    paymentLine => paymentLine.payment_method.use_payment_terminal === 'cardknox' &&
    ...
    Registries.Component.extend(PaymentScreen, PosCardknoxPaymentScreen);
